...
while True: # Loop ini akan terus berjalan sampai pernyataan break
    try:    # Menjalankan kode di dalam
        ...
        if nilai >= 90: #  Jika menggunakan operator dengan rentang tertentu contoh rentang 90 hingga 100, dan tambahkan --> nilai >=10 and nilai <=100
            hasil = "Lulus dengan nilai A"

        elif nilai >= 80: # nilai >= 80 and nilai < 90:
            hasil = "Lulus dengan nilai B"

        elif nilai >= 70: # nilai >= 70 and nilai < 80:
            hasil = "Lulus dengan nilai C"

        elif nilai >= 60: # nilai >= 60 and nilai < 70:
