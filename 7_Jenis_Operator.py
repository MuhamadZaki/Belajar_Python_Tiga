...
list_a = [1,2,3] # --> Inisialisasi variabel yang menyimpan data list, berisi 3 elemen data integer
list_b = [1,2,3] # --> Inisialisasi variabel yang menyimpan data list, berisi 3 elemen data integer

str_a = 'Tobrut' # --> Inisialisasi variabel yang menyimpan data string
str_b = 'Tobrut' # --> Inisialisasi variabel yang menyimpan data string

tuple_a = (10,)  # --> Inisialisasi variabel yang menyimpan data tuple, berisi 1 elemen data integer
tuple_b = (10,)  # --> Inisialisasi variabel yang menyimpan data tuple, berisi 1 elemen data integer
